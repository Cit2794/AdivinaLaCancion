...
<div class="cont align-items-center justify-content-center">
    <div class="col-md-11 mx-auto text-center">
        ...
        <h1 class="text" style="background-color: orange;">CANCIÓN 4</h1>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Datos de Ronda <?php echo $duelo; ?> - Canción 4</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
            <form method="post" action="bd/rondaCuatro.php">
